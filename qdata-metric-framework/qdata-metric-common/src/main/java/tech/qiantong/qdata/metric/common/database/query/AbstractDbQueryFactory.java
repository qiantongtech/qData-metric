...
import tech.qiantong.qdata.metric.common.database.datasource.AbstractDataSourceFactory;
import tech.qiantong.qdata.metric.common.database.datasource.DefaultDataSourceFactoryBean;
import tech.qiantong.qdata.metric.common.database.dialect.FileDialect;
import tech.qiantong.qdata.metric.common.database.dialect.OracleDialect;
    ...
    public List<Map<String, Object>> queryDbColumnByList(List<DbColumn> columns, String tableName, DbQueryProperty dbQueryProperty, String where, List<Map> orderByList, long offset, long size) {
        ...
        if (CollectionUtils.isNotEmpty(orderByList)) {
            ...
            for (int i = 0; i < orderByList.size(); i++) {
                ...
                if (tech.qiantong.qdata.metric.common.utils.StringUtils.isNotBlank(orderByColumn)) {
                    // 拼接表名 + 字段
